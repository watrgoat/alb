...
int main() {
    ...
    ServerState servers[3] = {
        { .address = 0xC0A80001, .mac = 0, .active_connections = 0, .weight = 1 },  // 192.168.0.1
        { .address = 0xC0A80002, .mac = 0, .active_connections = 0, .weight = 1 },  // 192.168.0.2
        { .address = 0xC0A80003, .mac = 0, .active_connections = 0, .weight = 1 },  // 192.168.0.3
    };
    ...
    auto create = (Strategy*(*)(ServerState*, int))dlsym(handle, "create_strategy");
