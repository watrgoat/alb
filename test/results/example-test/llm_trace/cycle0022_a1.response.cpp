...
private:
    ...
    static constexpr uint32_t kWeights[3] = {10070000, 3333000, 9680000};

public:
    WaterFillingStrategy(ServerState *svrs, int count)
        : servers(svrs), server_count(count), total_weight(0) {
